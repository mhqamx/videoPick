...
- **Instagram** — `www.instagram.com/reel/` / `www.instagram.com/p/` / `www.instagram.com/tv/`（支持视频与图文多图）
- **X(Twitter)** — `x.com/<user>/status/<id>` / `twitter.com/<user>/status/<id>`（cookie 模式）
...
## 当前状态
- iOS 端可粘贴分享文案并下载视频（抖音、TikTok、Instagram、X、B站、快手、小红书）
